...
class ShowtimeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSchedule = channel.unary_stream(
                ...
                response_deserializer=showtime__pb2.TimeSlot.FromString,
                )
        self.GetMoviesByDate = channel.unary_unary(
                '/Showtime/GetMoviesByDate',
                request_serializer=showtime__pb2.DateSlot.SerializeToString,
                response_deserializer=showtime__pb2.TimeSlot.FromString,
                )
...
def add_ShowtimeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSchedule': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=showtime__pb2.TimeSlot.SerializeToString,
            ),
            'GetMoviesByDate': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMoviesByDate,
                    request_deserializer=showtime__pb2.DateSlot.FromString,
                    response_serializer=showtime__pb2.TimeSlot.SerializeToString,
            ),
    }
...
class Showtime(object):
    ...
    def GetSchedule(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/Showtime/GetSchedule',
            ...
            showtime__pb2.TimeSlot.FromString,
    ...
    def GetMoviesByDate(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Showtime/GetMoviesByDate',
            showtime__pb2.DateSlot.SerializeToString,
            showtime__pb2.TimeSlot.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
