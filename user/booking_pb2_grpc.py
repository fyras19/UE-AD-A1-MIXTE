...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookings = channel.unary_stream(
                '/Booking/GetBookings',
                request_serializer=booking__pb2.EmptyObject.SerializeToString,
                response_deserializer=booking__pb2.BookingInfo.FromString,
                )
        self.GetBookingsByUserID = channel.unary_unary(
                '/Booking/GetBookingsByUserID',
                request_serializer=booking__pb2.UsedID.SerializeToString,
                response_deserializer=booking__pb2.BookingInfo.FromString,
                )
        self.AddBooking = channel.unary_unary(
                '/Booking/AddBooking',
                request_serializer=booking__pb2.UserBooking.SerializeToString,
                response_deserializer=booking__pb2.BookingInfo.FromString,
                )
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetBookings': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=booking__pb2.EmptyObject.FromString,
                    response_serializer=booking__pb2.BookingInfo.SerializeToString,
            ),
            'GetBookingsByUserID': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBookingsByUserID,
                    request_deserializer=booking__pb2.UsedID.FromString,
                    response_serializer=booking__pb2.BookingInfo.SerializeToString,
            ),
            'AddBooking': grpc.unary_unary_rpc_method_handler(
                    servicer.AddBooking,
                    request_deserializer=booking__pb2.UserBooking.FromString,
                    response_serializer=booking__pb2.BookingInfo.SerializeToString,
            ),
    }
...
class Booking(object):
    ...
    def GetBookings(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/Booking/GetBookings',
            booking__pb2.EmptyObject.SerializeToString,
            booking__pb2.BookingInfo.FromString,
    ...
    def GetBookingsByUserID(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Booking/GetBookingsByUserID',
            booking__pb2.UsedID.SerializeToString,
            booking__pb2.BookingInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def AddBooking(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Booking/AddBooking',
            booking__pb2.UserBooking.SerializeToString,
            booking__pb2.BookingInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
